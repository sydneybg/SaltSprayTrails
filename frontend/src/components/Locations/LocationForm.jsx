...
import { createLocation, updateLocation, fetchLocation, setErrorMessage, setLocation } from '../../store/locations';
  ...
  return (
    <div className="form-container">
      ...
      <input type="text" name="name" placeholder="Name" value={formData.name} onChange={handleChange} required className="form-input" />
        ...
        {!locationId && (
          <input type="text" name="imageUrl" placeholder="Image URL" value={formData.imageUrl} onChange={handleChange} required maxLength='255' className="form-input"/>
        )}
