...
export const fetchCollections = () => async (dispatch) => {
  ...
  export const updateCollection = (collectionId, collectionData) => async (dispatch) => {
    try {
      const response = await csrfFetch(`/api/collections/${collectionId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  export const addLocation = (collectionId, location) => async (dispatch) => {
    try {
      const response = await csrfFetch(`/api/collections/${collectionId}/locations`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  export const removeLocation = (collectionId, locationId) => async (dispatch) => {
    try {
      const response = await csrfFetch(`/api/collections/${collectionId}/locations/${locationId}`, {
        method: "DELETE",
      });
      if (response.ok) {
